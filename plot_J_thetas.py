...
#        std_os_cost_lqg = [51.26707978394956, 51.26707978394956, 51.26707978394956]
    ...
    ##----------------temp
    avg_cost_drkf_wdrc_file_10 = open(path + '/drkf_wdrc_mean_10.pkl', 'rb' )
    avg_cost_drkf_wdrc_10 = pickle.load(avg_cost_drkf_wdrc_file_10)
    avg_cost_drkf_wdrc_file_10.close()
    std_cost_drkf_wdrc_file_10 = open(path + '/drkf_wdrc_std_10.pkl', 'rb' )

...
class inf_MMSE_WDRC_both: # handle ambiguity for both x and v after the convergence of X_ss
    def __init__(self, theta, T, dist, noise_dist, system_data, mu_hat, Sigma_hat, x0_mean, x0_cov, x0_max, x0_min, mu_w, Sigma_w, w_max, w_min, v_max, v_min, M_hat, app_lambda):
        ...
        print("inf_MMSE_WDRC both / ", self.dist, " / ", self.noise_dist)
...
#        self.lambda_ = 3.5
    ...
    def optimize_penalty(self):
        ...
        print("inf MMSE WDRC Optimal penalty (lambda_star):", optimal_penalty)
...
#         return prob
    ...
    #The Gelbrich MMSE Estimation problem!! from "Adverisal Analytics"
    #handle both X and v ambiguity
...
#            print("t={}: False!".format(0))
        ...
        for t in range(self.max_iteration):
            ...
            if max_diff < self.error_bound:
                ...
                self.X_pred = P_post
                self.Alpha_opt = self.solve_DR_sdp(self.X_pred)

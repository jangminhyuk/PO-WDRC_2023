...
#    t = np.array([10, 15, 20, 25, 30, 35, 40, 45, 50])
    ...
    t = np.array([10, 12, 14, 16, 18, 20, 25, 30, 35, 40])
    
    J_lqr_mean = np.array(avg_cost_lqg[1:])
    J_wdrc_mean = np.array(avg_cost_wdrc[1:])
    J_drkf_wdrc_mean = np.array(avg_cost_drkf_wdrc[1:])
    J_drlqc_mean = np.array(avg_cost_drlqc[1:])
    
    J_lqr_std = np.array(std_cost_lqg[1:])
    J_wdrc_std = np.array(std_cost_wdrc[1:])
    J_drkf_wdrc_std = np.array(std_cost_drkf_wdrc[1:])
    J_drlqc_std = np.array(std_cost_drlqc[1:])
